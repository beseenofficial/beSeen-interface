    ...
    >
      ...
      >
        {broadcastOpen ? (
          ...
          <motion.div
            className="grid h-full min-h-0 min-w-0 grid-rows-[76px_minmax(0,1fr)_auto] bg-subtle min-[721px]:overflow-hidden min-[721px]:rounded-l-3xl min-[721px]:shadow-[-14px_0_10px_-18px_rgba(34,28,74,0.28)]"
