...
export function DiscoverHero({
  ...
  return (
    ...
    >
      <img
        className="pointer-events-none absolute right-[-110px] top-1/2 size-[620px] -translate-y-1/2 opacity-60 max-lg:right-[-210px] max-sm:right-[-250px] max-sm:size-[480px]"
        ...
        <div className="min-w-0">
          ...
          <label className="mt-7 flex min-h-[68px] max-w-3xl items-center gap-4 rounded-[20px] border border-[#d7dfec] bg-white p-2 pl-5 text-secondary shadow-[0_10px_28px_rgba(35,58,115,0.07)] transition focus-within:border-[#b6c7f3] focus-within:shadow-[0_12px_32px_rgba(16,69,245,0.1)] max-sm:min-h-14 max-sm:rounded-2xl max-sm:pl-4">
            ...
            <input
              ...
              disabled={disabled}
            />
            <span className="grid size-12 shrink-0 place-items-center rounded-full bg-brand text-white shadow-[0_8px_18px_rgba(16,69,245,0.22)] max-sm:size-10" aria-hidden="true">
              <Search size={21} />
            </span>
          </label>
        </div>
